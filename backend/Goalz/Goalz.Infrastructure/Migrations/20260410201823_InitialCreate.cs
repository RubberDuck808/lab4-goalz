        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PartyGroups_Parties_PartyId",
                        column: x => x.PartyId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PartyMembers_PartyGroups_PartyGroupId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PartyGroupAnswers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PartyGroupAnswers_Answers_AnswerId",
                        column: x => x.AnswerId,
                        principalTable: "Answers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PartyGroupAnswers_PartyGroups_PartyGroupId",
                        column: x => x.PartyGroupId,
                        principalTable: "PartyGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Parties_QuizId",
                table: "Parties",
                column: "QuizId");

            migrationBuilder.CreateIndex(
                name: "IX_PartyGroupAnswers_AnswerId",
                table: "PartyGroupAnswers",
                column: "AnswerId");

            migrationBuilder.CreateIndex(
                name: "IX_PartyGroupAnswers_PartyGroupId",
                table: "PartyGroupAnswers",
                column: "PartyGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_PartyGroups_PartyId",
                table: "PartyGroups",
                column: "PartyId");

            migrationBuilder.CreateIndex(
                name: "IX_PartyMembers_PartyGroupId",
                table: "PartyMembers",
                column: "PartyGroupId");
