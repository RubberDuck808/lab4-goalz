...
public class SensorDataService : ISensorDataService
{
    ...
    public async Task<IEnumerable<SensorDataResponse>> GetBySensorIdAsync(long sensorId, DateTime? from = null, DateTime? to = null, int? limit = null)
    {
        var data = await _repo.GetBySensorIdAsync(sensorId, from, to, limit);
